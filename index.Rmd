...
* Easy pipeline construction for statistical models with Stan.
...
<center>
<image src="./images/stan.png" height = "300px">
</center>
...
* For many independent replications:
...
* for each of `alpha` and `beta`, roughly x% of the posterior intervals should cover the analogous parameter values simulated from the joint prior.
* Simulation-based calibration extends this idea further (Cook et al. 2006; Talts et al. 2020).
...
* Persistent workers: `tar_make_clustermq()`
* Transient workers: `tar_make_future()`
...
## Coverage by 95% intervals is nominal
